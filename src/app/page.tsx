        ...
        <>
          <div className="hero-section">
            <div className="w-[98%] md:w-[60%] mx-auto pt-28 md:pt-40">
              <h2 className="text-4xl md:text-5xl text-center font-bold mb-5 md:leading-tight">10x your hiring and job search process with AI-powered support.</h2>
          ...
          <div className="grid grid-cols-3 px-20 gap-20 mt-20">
            <div className="flex items-start gap-5">
              ...
              <div>
                ...
                <p className="text-sm md:text-base md:leading-relaxed w-full">
